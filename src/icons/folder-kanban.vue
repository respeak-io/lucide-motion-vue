...
<template>
  ...
  >
    <FolderKanban :size="props.size" :strokeWidth="props.strokeWidth" />
  </AnimateIcon>
  ...
  <motion.svg
    ...
    overflow="visible"
      ...
      @animationComplete="notifyComplete"
        ...
        >
          <motion.path d="M8 10v4" :variants="variants.column" />
          <motion.path d="M12 10v2" :variants="variants.column" />
          <motion.path d="M16 10v6" :variants="variants.column" />
        </motion.g>
      </motion.svg>
</template>
